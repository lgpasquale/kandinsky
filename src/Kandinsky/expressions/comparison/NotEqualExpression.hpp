#ifndef KANDINSKY_NOTEQUALEXPRESSION_HPP_
#define KANDINSKY_NOTEQUALEXPRESSION_HPP_
...
namespace Kandinsky
{
    ...
    {
        return NotEqualExpression(BaseExpression::makePtr(arg1), BaseExpression::makePtr(arg2));
    }
}
